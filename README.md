...
[View the report](./ms_fabric_data_agent_report.pdf)

## 🧠 Overview

The report explains the concept of the Fabric Data Agent, which enables natural language queries across data sources such as Lakehouses, Warehouses, and Power BI semantic models.

## ⚙️ Topics Covered

- Microsoft Fabric architecture (OneLake, Lakehouse, Warehouse)  
- Natural language query processing (SQL, DAX, KQL)  
